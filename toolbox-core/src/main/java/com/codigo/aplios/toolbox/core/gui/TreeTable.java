...
public class TreeTable extends JTable {
	...
	public int getEditingRow() {
		...
		return (this.getColumnClass(this.editingColumn) == TreeTableModel.class) ? -1
				: this.editingRow;
	}
			...
			if (e instanceof MouseEvent)
				for (int counter = TreeTable.this.getColumnCount() - 1; counter >= 0; counter--)
					if (TreeTable.this.getColumnClass(counter) == TreeTableModel.class) {
						...
						MouseEvent newME = new MouseEvent(TreeTable.this.tree,
								me.getID(),
								me.getWhen(),
								me.getModifiers(),
								me.getX() - TreeTable.this.getCellRect(0, counter, true).x,
								me.getY(),
								me.getClickCount(),
								me.isPopupTrigger());
	...
	class ListToTreeSelectionModelWrapper extends DefaultTreeSelectionModel {
		...
		public ListToTreeSelectionModelWrapper() {
			...
			super();
			this.getListSelectionModel()
				.addListSelectionListener(this.createListSelectionListener());
		}
...
/*
 * The contents of this file are subject to the Sapient Public License Version 1.0 (the "License"); you may not use this
