...
public class AutoCompleteCombo extends PlainDocument {
	JComboBox comboBox;
	ComboBoxModel model;
	...
	public AutoCompleteCombo(final JComboBox comboBox) {
		...
		comboBox.addPropertyChangeListener(e -> {
			if (e.getPropertyName()
				.equals("editor"))
				AutoCompleteCombo.this.configureEditor((ComboBoxEditor) e.getNewValue());
			if (e.getPropertyName()
				.equals("model"))
				AutoCompleteCombo.this.model = (ComboBoxModel) e.getNewValue();
		});
		this.editorKeyListener = new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				AutoCompleteCombo.this.hitBackspace = false;
				switch (e.getKeyCode()) {
				// determine if the pressed key is backspace (needed by the remove method)
				case KeyEvent.VK_BACK_SPACE:
					AutoCompleteCombo.this.hitBackspace = true;
					AutoCompleteCombo.this.hitBackspaceOnSelection = AutoCompleteCombo.this.editor
						.getSelectionStart() != AutoCompleteCombo.this.editor.getSelectionEnd();
					break;
				// ignore delete key
		...
		this.editorFocusListener = new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (AutoCompleteCombo.this.hidePopupOnFocusLoss)
	...
	public static void enable(JComboBox comboBox) {
		...
		new AutoCompleteCombo(comboBox);
	}
	...
	private static void createAndShowGUI() {
		...
		AutoCompleteCombo.enable(comboBox);
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(() -> AutoCompleteCombo.createAndShowGUI());
	}
}