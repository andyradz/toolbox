...
public class InsertionSorterTests {
	...
	@Test
	@RepeatedTest(value = InsertionSorterTests.repeatTimes)
	public void shouldSortNumbersAscending() {

		// arrange
		this.sortable = SortingContext.create(new InsertionSorter<>(Integer::compare));
	...
	public void shouldSortNumberDescending() {
		...
		// arrange
		this.sortable = SortingContext.create(new InsertionSorter<>(Integer::compare, SortingMode.Descending));
