...
public class CocktailSorterTests {
	...
	@Test
	@RepeatedTest(value = CocktailSorterTests.repeatTimes)
	public void shouldSortNumbersAscending() {

		// arrange
		this.sortable = SortingContext.create(new CocktailSorter<>(Integer::compare));
	...
	public void shouldSortNumberDescending() {
		...
		// arrange
		this.sortable = SortingContext.create(new CocktailSorter<>(Integer::compare, SortingMode.Descending));
