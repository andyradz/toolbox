...
public class HotKeys extends JFrame {
	 ...
	 *
	 */
	private static final long serialVersionUID = -2259403714782614047L;
	...
	public static void main(String arg[]) {
		...
		actionMap.put("action_save", new AbstractAction() {
			private static final long serialVersionUID = 6465094244993375891L;
		...
		keyMap.put(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.Event.CTRL_MASK), "action_save");
